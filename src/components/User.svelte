<script lang="ts">
  ...
  const users: User[] = [
    { id: 1, name: "Masttauigssssssssssssssssssssssssassssssssssssssssssssssssssssssssssssssssssssssssssssssssan aasdasdds", email: "matt@mail.com", role: "Admin" },
  ...
  const columns: Column<User>[] = [
    ...
    { key: "name", header: "Name", class: "w-64" },
    { key: "email", header: "Email" },
    { key: "role", header: "Role", alignment: "center" },
  ];
...
<TableGrid data={users} {columns} {actions} />
